...
public class AcessoController {
	...
	public ResponseEntity<Acesso> salvarAcesso(@RequestBody Acesso acesso) { /*Recebe o JSON e converte para o Objeto Acesso*/
	...
	public ResponseEntity<String> deletarAcesso(@RequestBody Acesso acesso) { /*Recebe o JSON e converte para o Objeto Acesso*/
